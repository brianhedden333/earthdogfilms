...
const OurWork = () => {
  ...
  const commercialWork = [
    ...
    {
      title: "Awaken School - Spiritual and Successful Promo",
      description: "A promotional video for the Spiritual and Successful workshop hosted by Rachael Jayne Groover and the Awaken School",
      vimeoId: "1125623603",
      vimeoHash: "da2997325e",
  ...
  const handleVideoClick = (project: { title: string; vimeoId?: string; vimeoHash?: string; youtubeId?: string }) => {
    setSelectedVideo({
  ...
  return (
    <div className="min-h-screen bg-stone-50">
              ...
              <Card key={index} className="group cursor-pointer hover:shadow-xl transition-all duration-300 border-none overflow-hidden">
                <div onClick={() => handleVideoClick(project)}>
                  <div className="relative">
                    <img
                      src={getVideoThumbnail(project.vimeoId, undefined, project.thumbnail)}
                      alt={project.title}
      ...
      <VideoLightbox
        ...
        vimeoHash={selectedVideo?.vimeoHash}
